...
/// @title SquaresPoolV2
/// @notice Super Bowl Squares with Chainlink VRF + Chainlink Functions for multi-source score verification
contract SquaresPoolV2 is ISquaresPool, VRFConsumerBaseV2Plus, IFunctionsClient {
    using FunctionsRequestLib for FunctionsRequest;

    // ============ Constants ============
    uint16 private constant VRF_REQUEST_CONFIRMATIONS = 3;
    uint32 private constant VRF_CALLBACK_GAS_LIMIT = 500000;
    uint32 private constant VRF_NUM_WORDS = 2;
    bytes private constant VRF_EXTRA_ARGS = abi.encode(true); // nativePayment = true
    ...
    /// @notice Legacy function for interface compatibility
    ...
    /// @notice Legacy function - not needed with Chainlink Functions
